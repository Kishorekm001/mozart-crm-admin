...
const EditAreaModal = ({ editAreaModal, setEditAreaModal }) => {
  const modalStyles = {
    position: "absolute",
    top: "50%",
    left: "50%",
        ...
        <form class="p-4">
          ...
          <div class=" flex justify-center gap-16 mx-20 mt-10 mb-5">
            ...
            <button
              ...
              onClick={() => setEditAreaModal(false)}
            >
              Cancel
            </button>
          </div>
    ...
    <div class="ml-5 mr-5">
      <table class="border-1 border-primaryborder w-full mt-10 rounded-md">
        <thead>
          ...
          {areaTableHeaders.map((header, index) => {
            return (
              <th class="font-light text-sm border-1 border-primaryborder px-3 py-2">
                {header}
              </th>
      ...
      <EditAreaModal
        setEditAreaModal={setEditAreaModal}
